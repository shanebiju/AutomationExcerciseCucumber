...
public class HomePage extends BasePage{
    ...
    public void openWebsite(String ConfigKey){
        driver.get(ConfigReader.getConfigValue(ConfigKey));
    }
    public WebElement getLinkByText(String ConfigKey) {
        return driver.findElement(By.xpath("//a[text()=' " + ConfigReader.getConfigValue(ConfigKey) + "']"));
    }

    public boolean isLoggedIn(){
        try{
            return this.getLinkByText("navlink.logout").isDisplayed();
        } catch (Exception e) {
            return false;
        }
    }
